...
function PSI.write_to_CSV(
    ...
    _write_missing_power(problem, data_path, output_path)
end
...
function _write_missing_power(
    ...
    CSV.write(joinpath(output_path, "missing_power.csv"), missing_power)
    ...
    CSV.write(joinpath(output_path, "missing_capacity.csv"), missing_capacity)
end
